 ...
 * 주요 강조색상
 */
val GDSRed10 = Color(0xFF410002) // 매우 어두운 레드 색조
val GDSRed20 = Color(0xFF690005) // 어두운 레드 색조
val GDSRed30 = Color(0xFF93000A) // 더 밝은 어두운 레드 색조
val GDSRed40 = Color(0xFFBA1A1A) // 중간 정도의 레드 색조
val GDSRed80 = Color(0xFFFFB4AB) // 밝은 레드 색조
val GDSRed90 = Color(0xFFFFDAD6) // 매우 밝은 레드 색조
